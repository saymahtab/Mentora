...
const MentorPageMain = () => {

  const newUsers = USER.slice(0,3);
  ...
  return (
        ...
        <div className="flex items-start gap-3 border-b mt-6 pb-4 px-4">
          ...
          <div>
            <div className="flex items-center gap-4 mb-1">
              <Link to='/mentor/collection' className="font-medium text-[#0073E6] leading-3 mt-0 cursor-pointer hover:underline">
    ...
    <div className="bg-white rounded-lg ml-2 pt-5 border">
      <p className="font-medium text-lg text-[#404040] leading-7 pl-4">
        More Mentors
      </p>
      {USER.map((user) => (
        <div className="flex items-start gap-3 border-b mt-6 pb-4 px-4">
          <div className="avatar">
            <Link to={`/profile/${user.username}`} className="flex w-14">
              <img
                src={user.profileImg || "/avatar-placeholder.png"}
                className="cursor-pointer rounded-full"
              />
          ...
          <div>
            <div className="flex items-center gap-4 mb-1">
              <p className="font-medium text-[#0073E6] leading-3 mt-0 cursor-pointer hover:underline">
                {user.firstName} {user.lastName}
              </p>
              <p className="bg-[#C3F0DA] px-1 rounded-sm text-xs flex items-center gap-1 mt-1">
                <GoStarFill />5
